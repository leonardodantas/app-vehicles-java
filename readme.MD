...
- `available`: (opcional) `true` ou `false`
...
**GET /v1/vehicles/not/sold**

Retorna veículos cujo campo `sold` está como `false`.
...
```
GET http://localhost:8080/v1/vehicles/not/sold?page=0&size=10
```
